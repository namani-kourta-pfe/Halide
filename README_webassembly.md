...
-   Threads have very limited support via Target::WasmPThreads; see
...
You can use the `wasm_pthreads` feature to enable use of a normal pthread-based
...
-   The `wasm_pthreads` feature is not regularly built or tested by Halide at
    this time, and thus may suffer from occasional breakage.
